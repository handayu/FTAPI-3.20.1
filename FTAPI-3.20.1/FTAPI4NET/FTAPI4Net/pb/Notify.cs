...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class Notify {
    ...
    static Notify() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "Eh4KCnRyZExvZ2luZWQYAiACKAhSCnRyZExvZ2luZWQi9AEKCFFvdFJpZ2h0", 
            ...
            "ZVFvdFJpZ2h0IiYKCEFQSUxldmVsEhoKCGFwaUxldmVsGAMgAigJUghhcGlM", 
            "ZXZlbCJOCghBUElRdW90YRIaCghzdWJRdW90YRgBIAIoBVIIc3ViUXVvdGES", 
            "JgoOaGlzdG9yeUtMUXVvdGEYAiACKAVSDmhpc3RvcnlLTFF1b3RhIsUCCgNT", 
            "MkMSEgoEdHlwZRgBIAIoBVIEdHlwZRImCgVldmVudBgCIAEoCzIQLk5vdGlm", 
            "eS5HdHdFdmVudFIFZXZlbnQSOwoNcHJvZ3JhbVN0YXR1cxgDIAEoCzIVLk5v", 
            "dGlmeS5Qcm9ncmFtU3RhdHVzUg1wcm9ncmFtU3RhdHVzEjsKDWNvbm5lY3RT", 
            "dGF0dXMYBCABKAsyFS5Ob3RpZnkuQ29ubmVjdFN0YXR1c1INY29ubmVjdFN0", 
            "YXR1cxIsCghxb3RSaWdodBgFIAEoCzIQLk5vdGlmeS5Rb3RSaWdodFIIcW90", 
            "UmlnaHQSLAoIYXBpTGV2ZWwYBiABKAsyEC5Ob3RpZnkuQVBJTGV2ZWxSCGFw", 
            "aUxldmVsEiwKCGFwaVF1b3RhGAcgASgLMhAuTm90aWZ5LkFQSVF1b3RhUghh", 
            "cGlRdW90YSJ7CghSZXNwb25zZRIeCgdyZXRUeXBlGAEgAigFOgQtNDAwUgdy", 
            "ZXRUeXBlEhYKBnJldE1zZxgCIAEoCVIGcmV0TXNnEhgKB2VyckNvZGUYAyAB", 
            "KAVSB2VyckNvZGUSHQoDczJjGAQgASgLMgsuTm90aWZ5LlMyQ1IDczJjKr4B", 
            ...
            "QVBJUXVvdGEQBiqbBAoMR3R3RXZlbnRUeXBlEhUKEUd0d0V2ZW50VHlwZV9O", 
            "b25lEAASIwofR3R3RXZlbnRUeXBlX0xvY2FsQ2ZnTG9hZEZhaWxlZBABEiAK", 
            "HEd0d0V2ZW50VHlwZV9BUElTdnJSdW5GYWlsZWQQAhIcChhHdHdFdmVudFR5", 
            "cGVfRm9yY2VVcGRhdGUQAxIcChhHdHdFdmVudFR5cGVfTG9naW5GYWlsZWQQ", 
            "BBIiCh5HdHdFdmVudFR5cGVfVW5BZ3JlZURpc2NsYWltZXIQBRIeChpHdHdF", 
            "dmVudFR5cGVfTmV0Q2ZnTWlzc2luZxAGEhoKFkd0d0V2ZW50VHlwZV9LaWNr", 
            "ZWRPdXQQBxIgChxHdHdFdmVudFR5cGVfTG9naW5Qd2RDaGFuZ2VkEAgSGQoV", 
            "R3R3RXZlbnRUeXBlX0JhbkxvZ2luEAkSIgoeR3R3RXZlbnRUeXBlX05lZWRQ", 
            "aWNWZXJpZnlDb2RlEAoSJAogR3R3RXZlbnRUeXBlX05lZWRQaG9uZVZlcmlm", 
            "eUNvZGUQCxIgChxHdHdFdmVudFR5cGVfQXBwRGF0YU5vdEV4aXN0EAwSIwof", 
            "R3R3RXZlbnRUeXBlX05lc3NhcnlEYXRhTWlzc2luZxANEiAKHEd0d0V2ZW50", 
            "VHlwZV9UcmFkZVB3ZENoYW5nZWQQDhIhCh1HdHdFdmVudFR5cGVfRW5hYmxl", 
            "RGV2aWNlTG9jaxAPQj0KE2NvbS5mdXR1Lm9wZW5hcGkucGJaJmdpdGh1Yi5j", 
          "b20vZnV0dW9wZW4vZnRhcGk0Z28vcGIvbm90aWZ5"));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Notify_QotRight__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.Notify.QotRight, global::Futu.OpenApi.Pb.Notify.QotRight.Builder>(internal__static_Notify_QotRight__Descriptor,
                new string[] { "HkQotRight", "UsQotRight", "CnQotRight", "HkOptionQotRight", "HasUSOptionQotRight", "HkFutureQotRight", });
    ...
    public sealed partial class QotRight : pb::GeneratedMessage<QotRight, QotRight.Builder> {
      ...
      private static readonly string[] _qotRightFieldNames = new string[] { "cnQotRight", "hasUSOptionQotRight", "hkFutureQotRight", "hkOptionQotRight", "hkQotRight", "usQotRight" };
      private static readonly uint[] _qotRightFieldTags = new uint[] { 48, 64, 72, 56, 32, 40 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasUsQotRight) {
          output.WriteInt32(5, field_names[5], UsQotRight);
        }
        if (hasCnQotRight) {
