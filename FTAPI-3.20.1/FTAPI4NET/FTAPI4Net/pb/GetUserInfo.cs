...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class GetUserInfo {
    ...
    static GetUserInfo() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "byIZCgNDMlMSEgoEZmxhZxgCIAEoBVIEZmxhZyKPBAoDUzJDEhoKCG5pY2tO", 
            ...
            "BVIKdXBkYXRlVHlwZRIWCgZ3ZWJLZXkYCiABKAlSBndlYktleRIqChBoa09w", 
            "dGlvblFvdFJpZ2h0GAsgASgFUhBoa09wdGlvblFvdFJpZ2h0EjAKE2hhc1VT", 
            "T3B0aW9uUW90UmlnaHQYDCABKAhSE2hhc1VTT3B0aW9uUW90UmlnaHQSKgoQ", 
            "aGtGdXR1cmVRb3RSaWdodBgNIAEoBVIQaGtGdXR1cmVRb3RSaWdodBIaCghz", 
            "dWJRdW90YRgOIAEoBVIIc3ViUXVvdGESJgoOaGlzdG9yeUtMUXVvdGEYDyAB", 
            "KAVSDmhpc3RvcnlLTFF1b3RhIi0KB1JlcXVlc3QSIgoDYzJzGAEgAigLMhAu", 
            "R2V0VXNlckluZm8uQzJTUgNjMnMigAEKCFJlc3BvbnNlEh4KB3JldFR5cGUY", 
            "ASACKAU6BC00MDBSB3JldFR5cGUSFgoGcmV0TXNnGAIgASgJUgZyZXRNc2cS", 
            "GAoHZXJyQ29kZRgDIAEoBVIHZXJyQ29kZRIiCgNzMmMYBCABKAsyEC5HZXRV", 
            "c2VySW5mby5TMkNSA3MyYypOCgpVcGRhdGVUeXBlEhMKD1VwZGF0ZVR5cGVf", 
            "Tm9uZRAAEhUKEVVwZGF0ZVR5cGVfQWR2aWNlEAESFAoQVXBkYXRlVHlwZV9G", 
            "b3JjZRACKq4BCg1Vc2VySW5mb0ZpZWxkEhcKE1VzZXJJbmZvRmllbGRfQmFz", 
            "aWMQARIVChFVc2VySW5mb0ZpZWxkX0FQSRACEhoKFlVzZXJJbmZvRmllbGRf", 
            "UW90UmlnaHQQBBIcChhVc2VySW5mb0ZpZWxkX0Rpc2NsYWltZXIQCBIYChRV", 
            "c2VySW5mb0ZpZWxkX1VwZGF0ZRAQEhkKFFVzZXJJbmZvRmllbGRfV2ViS2V5", 
            "EIAQQkIKE2NvbS5mdXR1Lm9wZW5hcGkucGJaK2dpdGh1Yi5jb20vZnV0dW9w", 
          "ZW4vZnRhcGk0Z28vcGIvZ2V0dXNlcmluZm8="));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_GetUserInfo_S2C__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.GetUserInfo.S2C, global::Futu.OpenApi.Pb.GetUserInfo.S2C.Builder>(internal__static_GetUserInfo_S2C__Descriptor,
                new string[] { "NickName", "AvatarUrl", "ApiLevel", "HkQotRight", "UsQotRight", "CnQotRight", "IsNeedAgreeDisclaimer", "UserID", "UpdateType", "WebKey", "HkOptionQotRight", "HasUSOptionQotRight", "HkFutureQotRight", "SubQuota", "HistoryKLQuota", });
    ...
    public sealed partial class S2C : pb::GeneratedMessage<S2C, S2C.Builder> {
      ...
      private static readonly string[] _s2CFieldNames = new string[] { "apiLevel", "avatarUrl", "cnQotRight", "hasUSOptionQotRight", "historyKLQuota", "hkFutureQotRight", "hkOptionQotRight", "hkQotRight", "isNeedAgreeDisclaimer", "nickName", "subQuota", "updateType", "usQotRight", "userID", "webKey" };
      private static readonly uint[] _s2CFieldTags = new uint[] { 26, 18, 48, 96, 120, 104, 88, 32, 56, 10, 112, 72, 40, 64, 82 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasUsQotRight) {
          output.WriteInt32(5, field_names[12], UsQotRight);
        }
        if (hasCnQotRight) {
        ...
        if (hasUserID) {
          output.WriteInt64(8, field_names[13], UserID);
        }
        if (hasUpdateType) {
          output.WriteInt32(9, field_names[11], UpdateType);
        }
        if (hasWebKey) {
          output.WriteString(10, field_names[14], WebKey);
        }
