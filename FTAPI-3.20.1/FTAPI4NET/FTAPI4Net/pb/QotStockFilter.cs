...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class QotStockFilter {
    ...
    static QotStockFilter() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "c29ydERpchIYCgdxdWFydGVyGAYgAigFUgdxdWFydGVyIj4KCEJhc2VEYXRh", 
            "EhwKCWZpZWxkTmFtZRgBIAIoBVIJZmllbGROYW1lEhQKBXZhbHVlGAIgAigB", 
            "UgV2YWx1ZSJYCg5BY2N1bXVsYXRlRGF0YRIcCglmaWVsZE5hbWUYASACKAVS", 
            "CWZpZWxkTmFtZRIUCgV2YWx1ZRgCIAIoAVIFdmFsdWUSEgoEZGF5cxgDIAIo", 
            "BVIEZGF5cyJdCg1GaW5hbmNpYWxEYXRhEhwKCWZpZWxkTmFtZRgBIAIoBVIJ", 
            "ZmllbGROYW1lEhQKBXZhbHVlGAIgAigBUgV2YWx1ZRIYCgdxdWFydGVyGAMg", 
            "AigFUgdxdWFydGVyIq8CCglTdG9ja0RhdGESMAoIc2VjdXJpdHkYASACKAsy", 
            "FC5Rb3RfQ29tbW9uLlNlY3VyaXR5UghzZWN1cml0eRISCgRuYW1lGAIgAigJ", 
            "UgRuYW1lEj0KDGJhc2VEYXRhTGlzdBgDIAMoCzIZLlFvdF9TdG9ja0ZpbHRl", 
            "ci5CYXNlRGF0YVIMYmFzZURhdGFMaXN0Ek8KEmFjY3VtdWxhdGVEYXRhTGlz", 
            "dBgEIAMoCzIfLlFvdF9TdG9ja0ZpbHRlci5BY2N1bXVsYXRlRGF0YVISYWNj", 
            "dW11bGF0ZURhdGFMaXN0EkwKEWZpbmFuY2lhbERhdGFMaXN0GAUgAygLMh4u", 
            "UW90X1N0b2NrRmlsdGVyLkZpbmFuY2lhbERhdGFSEWZpbmFuY2lhbERhdGFM", 
            "aXN0IuECCgNDMlMSFAoFYmVnaW4YASACKAVSBWJlZ2luEhAKA251bRgCIAIo", 
            "BVIDbnVtEhYKBm1hcmtldBgDIAIoBVIGbWFya2V0EioKBXBsYXRlGAQgASgL", 
            "MhQuUW90X0NvbW1vbi5TZWN1cml0eVIFcGxhdGUSQwoOYmFzZUZpbHRlckxp", 
            "c3QYBSADKAsyGy5Rb3RfU3RvY2tGaWx0ZXIuQmFzZUZpbHRlclIOYmFzZUZp", 
            "bHRlckxpc3QSVQoUYWNjdW11bGF0ZUZpbHRlckxpc3QYBiADKAsyIS5Rb3Rf", 
            "U3RvY2tGaWx0ZXIuQWNjdW11bGF0ZUZpbHRlclIUYWNjdW11bGF0ZUZpbHRl", 
            "ckxpc3QSUgoTZmluYW5jaWFsRmlsdGVyTGlzdBgHIAMoCzIgLlFvdF9TdG9j", 
            "a0ZpbHRlci5GaW5hbmNpYWxGaWx0ZXJSE2ZpbmFuY2lhbEZpbHRlckxpc3Qi", 
            "dQoDUzJDEhoKCGxhc3RQYWdlGAEgAigIUghsYXN0UGFnZRIaCghhbGxDb3Vu", 
            "dBgCIAIoBVIIYWxsQ291bnQSNgoIZGF0YUxpc3QYAyADKAsyGi5Rb3RfU3Rv", 
            "Y2tGaWx0ZXIuU3RvY2tEYXRhUghkYXRhTGlzdCIxCgdSZXF1ZXN0EiYKA2My", 
            "cxgBIAIoCzIULlFvdF9TdG9ja0ZpbHRlci5DMlNSA2MycyKEAQoIUmVzcG9u", 
            "c2USHgoHcmV0VHlwZRgBIAIoBToELTQwMFIHcmV0VHlwZRIWCgZyZXRNc2cY", 
            "AiABKAlSBnJldE1zZxIYCgdlcnJDb2RlGAMgASgFUgdlcnJDb2RlEiYKA3My", 
            "YxgEIAEoCzIULlFvdF9TdG9ja0ZpbHRlci5TMkNSA3MyYyqcBAoKU3RvY2tG", 
            "aWVsZBIWChJTdG9ja0ZpZWxkX1Vua25vd24QABIYChRTdG9ja0ZpZWxkX1N0", 
            "b2NrQ29kZRABEhgKFFN0b2NrRmllbGRfU3RvY2tOYW1lEAISFwoTU3RvY2tG", 
            "aWVsZF9DdXJQcmljZRADEiwKKFN0b2NrRmllbGRfQ3VyUHJpY2VUb0hpZ2hl", 
            "c3Q1MldlZWtzUmF0aW8QBBIrCidTdG9ja0ZpZWxkX0N1clByaWNlVG9Mb3dl", 
            "c3Q1MldlZWtzUmF0aW8QBRItCilTdG9ja0ZpZWxkX0hpZ2hQcmljZVRvSGln", 
            "aGVzdDUyV2Vla3NSYXRpbxAGEisKJ1N0b2NrRmllbGRfTG93UHJpY2VUb0xv", 
            "d2VzdDUyV2Vla3NSYXRpbxAHEhoKFlN0b2NrRmllbGRfVm9sdW1lUmF0aW8Q", 
            "CBIaChZTdG9ja0ZpZWxkX0JpZEFza1JhdGlvEAkSFwoTU3RvY2tGaWVsZF9M", 
            "b3RQcmljZRAKEhgKFFN0b2NrRmllbGRfTWFya2V0VmFsEAsSFwoTU3RvY2tG", 
            "aWVsZF9QZUFubnVhbBAMEhQKEFN0b2NrRmllbGRfUGVUVE0QDRIVChFTdG9j", 
            "a0ZpZWxkX1BiUmF0ZRAOEh0KGVN0b2NrRmllbGRfQ2hhbmdlUmF0ZTVtaW4Q", 
            "DxIiCh5TdG9ja0ZpZWxkX0NoYW5nZVJhdGVCZWdpblllYXIQECrJAQoPQWNj", 
            "dW11bGF0ZUZpZWxkEhsKF0FjY3VtdWxhdGVGaWVsZF9Vbmtub3duEAASHgoa", 
            "QWNjdW11bGF0ZUZpZWxkX0NoYW5nZVJhdGUQARIdChlBY2N1bXVsYXRlRmll", 
            "bGRfQW1wbGl0dWRlEAISGgoWQWNjdW11bGF0ZUZpZWxkX1ZvbHVtZRADEhwK", 
            "GEFjY3VtdWxhdGVGaWVsZF9UdXJub3ZlchAEEiAKHEFjY3VtdWxhdGVGaWVs", 
            "ZF9UdXJub3ZlclJhdGUQBSrHAgoORmluYW5jaWFsRmllbGQSGgoWRmluYW5j", 
            "aWFsRmllbGRfVW5rbm93bhAAEhwKGEZpbmFuY2lhbEZpZWxkX05ldFByb2Zp", 
            "dBABEiIKHkZpbmFuY2lhbEZpZWxkX05ldFByb2ZpdEdyb3d0aBACEiAKHEZp", 
            "bmFuY2lhbEZpZWxkX1N1bU9mQnVzaW5lc3MQAxImCiJGaW5hbmNpYWxGaWVs", 
            "ZF9TdW1PZkJ1c2luZXNzR3Jvd3RoEAQSIAocRmluYW5jaWFsRmllbGRfTmV0", 
            "UHJvZml0UmF0ZRAFEiIKHkZpbmFuY2lhbEZpZWxkX0dyb3NzUHJvZml0UmF0", 
            "ZRAGEiAKHEZpbmFuY2lhbEZpZWxkX0RlYnRBc3NldFJhdGUQBxIlCiFGaW5h", 
            "bmNpYWxGaWVsZF9SZXR1cm5PbkVxdWl0eVJhdGUQCCrZAQoQRmluYW5jaWFs", 
            "UXVhcnRlchIcChhGaW5hbmNpYWxRdWFydGVyX1Vua25vd24QABIbChdGaW5h", 
            "bmNpYWxRdWFydGVyX0FubnVhbBABEiEKHUZpbmFuY2lhbFF1YXJ0ZXJfRmly", 
            "c3RRdWFydGVyEAISHAoYRmluYW5jaWFsUXVhcnRlcl9JbnRlcmltEAMSIQod", 
            "RmluYW5jaWFsUXVhcnRlcl9UaGlyZFF1YXJ0ZXIQBBImCiJGaW5hbmNpYWxR", 
            "dWFydGVyX01vc3RSZWNlbnRRdWFydGVyEAUqQgoHU29ydERpchIOCgpTb3J0", 
            "RGlyX05vEAASEgoOU29ydERpcl9Bc2NlbmQQARITCg9Tb3J0RGlyX0Rlc2Nl", 
            "bmQQAkJFChNjb20uZnV0dS5vcGVuYXBpLnBiWi5naXRodWIuY29tL2Z1dHVv", 
          "cGVuL2Z0YXBpNGdvL3BiL3FvdHN0b2NrZmlsdGVy"));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Qot_StockFilter_BaseData__Descriptor = Descriptor.MessageTypes[3];
        ...
        internal__static_Qot_StockFilter_AccumulateData__Descriptor = Descriptor.MessageTypes[4];
        ...
        internal__static_Qot_StockFilter_FinancialData__Descriptor = Descriptor.MessageTypes[5];
        ...
        internal__static_Qot_StockFilter_StockData__Descriptor = Descriptor.MessageTypes[6];
        ...
        internal__static_Qot_StockFilter_C2S__Descriptor = Descriptor.MessageTypes[7];
        internal__static_Qot_StockFilter_C2S__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.QotStockFilter.C2S, global::Futu.OpenApi.Pb.QotStockFilter.C2S.Builder>(internal__static_Qot_StockFilter_C2S__Descriptor,
                new string[] { "Begin", "Num", "Market", "Plate", "BaseFilterList", "AccumulateFilterList", "FinancialFilterList", });
        internal__static_Qot_StockFilter_S2C__Descriptor = Descriptor.MessageTypes[8];
        ...
        internal__static_Qot_StockFilter_Request__Descriptor = Descriptor.MessageTypes[9];
        internal__static_Qot_StockFilter_Request__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.QotStockFilter.Request, global::Futu.OpenApi.Pb.QotStockFilter.Request.Builder>(internal__static_Qot_StockFilter_Request__Descriptor,
                new string[] { "C2S", });
        internal__static_Qot_StockFilter_Response__Descriptor = Descriptor.MessageTypes[10];
    ...
    public sealed partial class C2S : pb::GeneratedMessage<C2S, C2S.Builder> {
      ...
      private static readonly string[] _c2SFieldNames = new string[] { "accumulateFilterList", "baseFilterList", "begin", "financialFilterList", "market", "num", "plate" };
      private static readonly uint[] _c2SFieldTags = new uint[] { 50, 42, 8, 58, 24, 16, 34 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasNum) {
          output.WriteInt32(2, field_names[5], Num);
        }
        if (hasMarket) {
          output.WriteInt32(3, field_names[4], Market);
        }
        if (hasPlate) {
          output.WriteMessage(4, field_names[6], Plate);
        }
        ...
        if (financialFilterList_.Count > 0) {
          output.WriteMessageArray(7, field_names[3], financialFilterList_);
        }
        UnknownFields.WriteTo(output);
      }
