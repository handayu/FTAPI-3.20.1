...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class TrdPlaceOrder {
    ...
    static TrdPlaceOrder() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "bi5wcm90bxoQVHJkX0NvbW1vbi5wcm90byLeAgoDQzJTEiwKCHBhY2tldElE", 
            ...
            "bWFyaxgLIAEoCVIGcmVtYXJrIk4KA1MyQxItCgZoZWFkZXIYASACKAsyFS5U", 
            "cmRfQ29tbW9uLlRyZEhlYWRlclIGaGVhZGVyEhgKB29yZGVySUQYAiABKARS", 
            "B29yZGVySUQiMAoHUmVxdWVzdBIlCgNjMnMYASACKAsyEy5UcmRfUGxhY2VP", 
            "cmRlci5DMlNSA2MycyKDAQoIUmVzcG9uc2USHgoHcmV0VHlwZRgBIAIoBToE", 
            "LTQwMFIHcmV0VHlwZRIWCgZyZXRNc2cYAiABKAlSBnJldE1zZxIYCgdlcnJD", 
            "b2RlGAMgASgFUgdlcnJDb2RlEiUKA3MyYxgEIAEoCzITLlRyZF9QbGFjZU9y", 
            "ZGVyLlMyQ1IDczJjQkQKE2NvbS5mdXR1Lm9wZW5hcGkucGJaLWdpdGh1Yi5j", 
          "b20vZnV0dW9wZW4vZnRhcGk0Z28vcGIvdHJkcGxhY2VvcmRlcg=="));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Trd_PlaceOrder_C2S__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.TrdPlaceOrder.C2S, global::Futu.OpenApi.Pb.TrdPlaceOrder.C2S.Builder>(internal__static_Trd_PlaceOrder_C2S__Descriptor,
                new string[] { "PacketID", "Header", "TrdSide", "OrderType", "Code", "Qty", "Price", "AdjustPrice", "AdjustSideAndLimit", "SecMarket", "Remark", });
    ...
    public sealed partial class C2S : pb::GeneratedMessage<C2S, C2S.Builder> {
      ...
      private static readonly string[] _c2SFieldNames = new string[] { "adjustPrice", "adjustSideAndLimit", "code", "header", "orderType", "packetID", "price", "qty", "remark", "secMarket", "trdSide" };
      private static readonly uint[] _c2SFieldTags = new uint[] { 64, 73, 42, 18, 32, 10, 57, 49, 90, 80, 24 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasPacketID) {
          output.WriteMessage(1, field_names[5], PacketID);
        }
        if (hasHeader) {
          output.WriteMessage(2, field_names[3], Header);
        }
        if (hasTrdSide) {
          output.WriteInt32(3, field_names[10], TrdSide);
        }
        if (hasOrderType) {
          output.WriteInt32(4, field_names[4], OrderType);
        }
        if (hasCode) {
          output.WriteString(5, field_names[2], Code);
        }
        if (hasQty) {
          output.WriteDouble(6, field_names[7], Qty);
        }
        if (hasPrice) {
        ...
        if (hasSecMarket) {
          output.WriteInt32(10, field_names[9], SecMarket);
        }
        if (hasRemark) {
          output.WriteString(11, field_names[8], Remark);
        }
