...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class TrdModifyOrder {
    ...
    static TrdModifyOrder() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "bW9uLnByb3RvGhBUcmRfQ29tbW9uLnByb3RvIrQCCgNDMlMSLAoIcGFja2V0", 
            ...
            "b2RpZnlPcmRlck9wEhYKBmZvckFsbBgFIAEoCFIGZm9yQWxsEhAKA3F0eRgI", 
            "IAEoAVIDcXR5EhQKBXByaWNlGAkgASgBUgVwcmljZRIgCgthZGp1c3RQcmlj", 
            "ZRgKIAEoCFILYWRqdXN0UHJpY2USLgoSYWRqdXN0U2lkZUFuZExpbWl0GAsg", 
            "ASgBUhJhZGp1c3RTaWRlQW5kTGltaXQiTgoDUzJDEi0KBmhlYWRlchgBIAIo", 
            "CzIVLlRyZF9Db21tb24uVHJkSGVhZGVyUgZoZWFkZXISGAoHb3JkZXJJRBgC", 
            "IAIoBFIHb3JkZXJJRCIxCgdSZXF1ZXN0EiYKA2MycxgBIAIoCzIULlRyZF9N", 
            "b2RpZnlPcmRlci5DMlNSA2MycyKEAQoIUmVzcG9uc2USHgoHcmV0VHlwZRgB", 
            "IAIoBToELTQwMFIHcmV0VHlwZRIWCgZyZXRNc2cYAiABKAlSBnJldE1zZxIY", 
            "CgdlcnJDb2RlGAMgASgFUgdlcnJDb2RlEiYKA3MyYxgEIAEoCzIULlRyZF9N", 
            "b2RpZnlPcmRlci5TMkNSA3MyY0JFChNjb20uZnV0dS5vcGVuYXBpLnBiWi5n", 
          "aXRodWIuY29tL2Z1dHVvcGVuL2Z0YXBpNGdvL3BiL3RyZG1vZGlmeW9yZGVy"));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Trd_ModifyOrder_C2S__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.TrdModifyOrder.C2S, global::Futu.OpenApi.Pb.TrdModifyOrder.C2S.Builder>(internal__static_Trd_ModifyOrder_C2S__Descriptor,
                new string[] { "PacketID", "Header", "OrderID", "ModifyOrderOp", "ForAll", "Qty", "Price", "AdjustPrice", "AdjustSideAndLimit", });
    ...
    public sealed partial class C2S : pb::GeneratedMessage<C2S, C2S.Builder> {
      ...
      private static readonly string[] _c2SFieldNames = new string[] { "adjustPrice", "adjustSideAndLimit", "forAll", "header", "modifyOrderOp", "orderID", "packetID", "price", "qty" };
      private static readonly uint[] _c2SFieldTags = new uint[] { 80, 89, 40, 18, 32, 24, 10, 73, 65 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasHeader) {
          output.WriteMessage(2, field_names[3], Header);
        }
        if (hasOrderID) {
          output.WriteUInt64(3, field_names[5], OrderID);
        }
        if (hasModifyOrderOp) {
          output.WriteInt32(4, field_names[4], ModifyOrderOp);
        }
        if (hasForAll) {
          output.WriteBool(5, field_names[2], ForAll);
        }
        if (hasQty) {
          output.WriteDouble(8, field_names[8], Qty);
        }
        if (hasPrice) {
          output.WriteDouble(9, field_names[7], Price);
        }
        if (hasAdjustPrice) {
