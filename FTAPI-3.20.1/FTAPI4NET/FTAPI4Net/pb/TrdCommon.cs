...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class TrdCommon {
    ...
    static TrdCommon() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "IAIoBVIJdHJkTWFya2V0IpgBCgZUcmRBY2MSFgoGdHJkRW52GAEgAigFUgZ0", 
            "cmRFbnYSFAoFYWNjSUQYAiACKARSBWFjY0lEEiwKEXRyZE1hcmtldEF1dGhM", 
            "aXN0GAMgAygFUhF0cmRNYXJrZXRBdXRoTGlzdBIYCgdhY2NUeXBlGAQgASgF", 
            "UgdhY2NUeXBlEhgKB2NhcmROdW0YBSABKAlSB2NhcmROdW0ikgQKBUZ1bmRz", 
            "EhQKBXBvd2VyGAEgAigBUgVwb3dlchIgCgt0b3RhbEFzc2V0cxgCIAIoAVIL", 
            "dG90YWxBc3NldHMSEgoEY2FzaBgDIAIoAVIEY2FzaBIcCgltYXJrZXRWYWwY", 
            "BCACKAFSCW1hcmtldFZhbBIeCgpmcm96ZW5DYXNoGAUgAigBUgpmcm96ZW5D", 
            "YXNoEhoKCGRlYnRDYXNoGAYgAigBUghkZWJ0Q2FzaBIsChFhdmxXaXRoZHJh", 
            "d2FsQ2FzaBgHIAIoAVIRYXZsV2l0aGRyYXdhbENhc2gSGgoIY3VycmVuY3kY", 
            "CCABKAVSCGN1cnJlbmN5EiYKDmF2YWlsYWJsZUZ1bmRzGAkgASgBUg5hdmFp", 
            "bGFibGVGdW5kcxIiCgx1bnJlYWxpemVkUEwYCiABKAFSDHVucmVhbGl6ZWRQ", 
            "TBIeCgpyZWFsaXplZFBMGAsgASgBUgpyZWFsaXplZFBMEhwKCXJpc2tMZXZl", 
            "bBgMIAEoBVIJcmlza0xldmVsEiQKDWluaXRpYWxNYXJnaW4YDSABKAFSDWlu", 
            "aXRpYWxNYXJnaW4SLAoRbWFpbnRlbmFuY2VNYXJnaW4YDiABKAFSEW1haW50", 
            "ZW5hbmNlTWFyZ2luEjsKDGNhc2hJbmZvTGlzdBgPIAMoCzIXLlRyZF9Db21t", 
            "b24uQWNjQ2FzaEluZm9SDGNhc2hJbmZvTGlzdCKwBAoIUG9zaXRpb24SHgoK", 
            "cG9zaXRpb25JRBgBIAIoBFIKcG9zaXRpb25JRBIiCgxwb3NpdGlvblNpZGUY", 
            "AiACKAVSDHBvc2l0aW9uU2lkZRISCgRjb2RlGAMgAigJUgRjb2RlEhIKBG5h", 
            "bWUYBCACKAlSBG5hbWUSEAoDcXR5GAUgAigBUgNxdHkSHgoKY2FuU2VsbFF0", 
            "eRgGIAIoAVIKY2FuU2VsbFF0eRIUCgVwcmljZRgHIAIoAVIFcHJpY2USHAoJ", 
            "Y29zdFByaWNlGAggASgBUgljb3N0UHJpY2USEAoDdmFsGAkgAigBUgN2YWwS", 
            "FAoFcGxWYWwYCiACKAFSBXBsVmFsEhgKB3BsUmF0aW8YCyABKAFSB3BsUmF0", 
            "aW8SHAoJc2VjTWFya2V0GAwgASgFUglzZWNNYXJrZXQSGQoIdGRfcGxWYWwY", 
            "FSABKAFSB3RkUGxWYWwSGwoJdGRfdHJkVmFsGBYgASgBUgh0ZFRyZFZhbBIb", 
            "Cgl0ZF9idXlWYWwYFyABKAFSCHRkQnV5VmFsEhsKCXRkX2J1eVF0eRgYIAEo", 
            "AVIIdGRCdXlRdHkSHQoKdGRfc2VsbFZhbBgZIAEoAVIJdGRTZWxsVmFsEh0K", 
            "CnRkX3NlbGxRdHkYGiABKAFSCXRkU2VsbFF0eRIiCgx1bnJlYWxpemVkUEwY", 
            "HCABKAFSDHVucmVhbGl6ZWRQTBIeCgpyZWFsaXplZFBMGB0gASgBUgpyZWFs", 
            "aXplZFBMIpEECgVPcmRlchIYCgd0cmRTaWRlGAEgAigFUgd0cmRTaWRlEhwK", 
            "CW9yZGVyVHlwZRgCIAIoBVIJb3JkZXJUeXBlEiAKC29yZGVyU3RhdHVzGAMg", 
            "AigFUgtvcmRlclN0YXR1cxIYCgdvcmRlcklEGAQgAigEUgdvcmRlcklEEhwK", 
            "CW9yZGVySURFeBgFIAIoCVIJb3JkZXJJREV4EhIKBGNvZGUYBiACKAlSBGNv", 
            "ZGUSEgoEbmFtZRgHIAIoCVIEbmFtZRIQCgNxdHkYCCACKAFSA3F0eRIUCgVw", 
            "cmljZRgJIAEoAVIFcHJpY2USHgoKY3JlYXRlVGltZRgKIAIoCVIKY3JlYXRl", 
            "VGltZRIeCgp1cGRhdGVUaW1lGAsgAigJUgp1cGRhdGVUaW1lEhgKB2ZpbGxR", 
            "dHkYDCABKAFSB2ZpbGxRdHkSIgoMZmlsbEF2Z1ByaWNlGA0gASgBUgxmaWxs", 
            "QXZnUHJpY2USHgoKbGFzdEVyck1zZxgOIAEoCVIKbGFzdEVyck1zZxIcCglz", 
            "ZWNNYXJrZXQYDyABKAVSCXNlY01hcmtldBIoCg9jcmVhdGVUaW1lc3RhbXAY", 
            "ECABKAFSD2NyZWF0ZVRpbWVzdGFtcBIoCg91cGRhdGVUaW1lc3RhbXAYESAB", 
            "KAFSD3VwZGF0ZVRpbWVzdGFtcBIWCgZyZW1hcmsYEiABKAlSBnJlbWFyayLj", 
            "AwoJT3JkZXJGaWxsEhgKB3RyZFNpZGUYASACKAVSB3RyZFNpZGUSFgoGZmls", 
            "bElEGAIgAigEUgZmaWxsSUQSGgoIZmlsbElERXgYAyACKAlSCGZpbGxJREV4", 
            "EhgKB29yZGVySUQYBCABKARSB29yZGVySUQSHAoJb3JkZXJJREV4GAUgASgJ", 
            "UglvcmRlcklERXgSEgoEY29kZRgGIAIoCVIEY29kZRISCgRuYW1lGAcgAigJ", 
            "UgRuYW1lEhAKA3F0eRgIIAIoAVIDcXR5EhQKBXByaWNlGAkgAigBUgVwcmlj", 
            "ZRIeCgpjcmVhdGVUaW1lGAogAigJUgpjcmVhdGVUaW1lEigKD2NvdW50ZXJC", 
            "cm9rZXJJRBgLIAEoBVIPY291bnRlckJyb2tlcklEEiwKEWNvdW50ZXJCcm9r", 
            "ZXJOYW1lGAwgASgJUhFjb3VudGVyQnJva2VyTmFtZRIcCglzZWNNYXJrZXQY", 
            "DSABKAVSCXNlY01hcmtldBIoCg9jcmVhdGVUaW1lc3RhbXAYDiABKAFSD2Ny", 
            "ZWF0ZVRpbWVzdGFtcBIoCg91cGRhdGVUaW1lc3RhbXAYDyABKAFSD3VwZGF0", 
            "ZVRpbWVzdGFtcBIWCgZzdGF0dXMYECABKAVSBnN0YXR1cyLMAQoKTWF4VHJk", 
            "UXR5cxIeCgptYXhDYXNoQnV5GAEgAigBUgptYXhDYXNoQnV5EjAKE21heENh", 
            "c2hBbmRNYXJnaW5CdXkYAiABKAFSE21heENhc2hBbmRNYXJnaW5CdXkSKAoP", 
            "bWF4UG9zaXRpb25TZWxsGAMgAigBUg9tYXhQb3NpdGlvblNlbGwSIgoMbWF4", 
            "U2VsbFNob3J0GAQgASgBUgxtYXhTZWxsU2hvcnQSHgoKbWF4QnV5QmFjaxgF", 
            "IAEoAVIKbWF4QnV5QmFjayKBAQoTVHJkRmlsdGVyQ29uZGl0aW9ucxIaCghj", 
            "b2RlTGlzdBgBIAMoCVIIY29kZUxpc3QSFgoGaWRMaXN0GAIgAygEUgZpZExp", 
            "c3QSHAoJYmVnaW5UaW1lGAMgASgJUgliZWdpblRpbWUSGAoHZW5kVGltZRgE", 
            "IAEoCVIHZW5kVGltZSouCgZUcmRFbnYSEwoPVHJkRW52X1NpbXVsYXRlEAAS", 
            "DwoLVHJkRW52X1JlYWwQASqDAQoJVHJkTWFya2V0EhUKEVRyZE1hcmtldF9V", 
            "bmtub3duEAASEAoMVHJkTWFya2V0X0hLEAESEAoMVHJkTWFya2V0X1VTEAIS", 
            "EAoMVHJkTWFya2V0X0NOEAMSEgoOVHJkTWFya2V0X0hLQ0MQBBIVChFUcmRN", 
            "YXJrZXRfRnV0dXJlcxAFKoIBCgxUcmRTZWNNYXJrZXQSGAoUVHJkU2VjTWFy", 
            "a2V0X1Vua25vd24QABITCg9UcmRTZWNNYXJrZXRfSEsQARITCg9UcmRTZWNN", 
            "YXJrZXRfVVMQAhIWChJUcmRTZWNNYXJrZXRfQ05fU0gQHxIWChJUcmRTZWNN", 
            "YXJrZXRfQ05fU1oQICptCgdUcmRTaWRlEhMKD1RyZFNpZGVfVW5rbm93bhAA", 
            "Eg8KC1RyZFNpZGVfQnV5EAESEAoMVHJkU2lkZV9TZWxsEAISFQoRVHJkU2lk", 
            "ZV9TZWxsU2hvcnQQAxITCg9UcmRTaWRlX0J1eUJhY2sQBCraAQoJT3JkZXJU", 
            "eXBlEhUKEU9yZGVyVHlwZV9Vbmtub3duEAASFAoQT3JkZXJUeXBlX05vcm1h", 
            "bBABEhQKEE9yZGVyVHlwZV9NYXJrZXQQAhIbChdPcmRlclR5cGVfQWJzb2x1", 
            "dGVMaW1pdBAFEhUKEU9yZGVyVHlwZV9BdWN0aW9uEAYSGgoWT3JkZXJUeXBl", 
            "X0F1Y3Rpb25MaW1pdBAHEhoKFk9yZGVyVHlwZV9TcGVjaWFsTGltaXQQCBIe", 
            "ChpPcmRlclR5cGVfU3BlY2lhbExpbWl0X0FsbBAJKvwDCgtPcmRlclN0YXR1", 
            "cxIbChdPcmRlclN0YXR1c19VbnN1Ym1pdHRlZBAAEiAKE09yZGVyU3RhdHVz", 
            "X1Vua25vd24Q////////////ARIdChlPcmRlclN0YXR1c19XYWl0aW5nU3Vi", 
            "bWl0EAESGgoWT3JkZXJTdGF0dXNfU3VibWl0dGluZxACEhwKGE9yZGVyU3Rh", 
            "dHVzX1N1Ym1pdEZhaWxlZBADEhcKE09yZGVyU3RhdHVzX1RpbWVPdXQQBBIZ", 
            "ChVPcmRlclN0YXR1c19TdWJtaXR0ZWQQBRIbChdPcmRlclN0YXR1c19GaWxs", 
            "ZWRfUGFydBAKEhoKFk9yZGVyU3RhdHVzX0ZpbGxlZF9BbGwQCxIfChtPcmRl", 
            "clN0YXR1c19DYW5jZWxsaW5nX1BhcnQQDBIeChpPcmRlclN0YXR1c19DYW5j", 
            "ZWxsaW5nX0FsbBANEh4KGk9yZGVyU3RhdHVzX0NhbmNlbGxlZF9QYXJ0EA4S", 
            "HQoZT3JkZXJTdGF0dXNfQ2FuY2VsbGVkX0FsbBAPEhYKEk9yZGVyU3RhdHVz", 
            "X0ZhaWxlZBAVEhgKFE9yZGVyU3RhdHVzX0Rpc2FibGVkEBYSFwoTT3JkZXJT", 
            "dGF0dXNfRGVsZXRlZBAXEh0KGU9yZGVyU3RhdHVzX0ZpbGxDYW5jZWxsZWQQ", 
            "GCplCg9PcmRlckZpbGxTdGF0dXMSFgoST3JkZXJGaWxsU3RhdHVzX09LEAAS", 
            "HQoZT3JkZXJGaWxsU3RhdHVzX0NhbmNlbGxlZBABEhsKF09yZGVyRmlsbFN0", 
            "YXR1c19DaGFuZ2VkEAIqYAoMUG9zaXRpb25TaWRlEhUKEVBvc2l0aW9uU2lk", 
            "ZV9Mb25nEAASIQoUUG9zaXRpb25TaWRlX1Vua25vd24Q////////////ARIW", 
            "ChJQb3NpdGlvblNpZGVfU2hvcnQQASqtAQoNTW9kaWZ5T3JkZXJPcBIZChVN", 
            "b2RpZnlPcmRlck9wX1Vua25vd24QABIYChRNb2RpZnlPcmRlck9wX05vcm1h", 
            "bBABEhgKFE1vZGlmeU9yZGVyT3BfQ2FuY2VsEAISGQoVTW9kaWZ5T3JkZXJP", 
            "cF9EaXNhYmxlEAMSGAoUTW9kaWZ5T3JkZXJPcF9FbmFibGUQBBIYChRNb2Rp", 
            "ZnlPcmRlck9wX0RlbGV0ZRAFKlAKClRyZEFjY1R5cGUSFgoSVHJkQWNjVHlw", 
            "ZV9Vbmtub3duEAASEwoPVHJkQWNjVHlwZV9DYXNoEAESFQoRVHJkQWNjVHlw", 
            "ZV9NYXJnaW4QAipWCghDdXJyZW5jeRIUChBDdXJyZW5jeV9Vbmtub3duEAAS", 
            "EAoMQ3VycmVuY3lfSEtEEAESEAoMQ3VycmVuY3lfVVNEEAISEAoMQ3VycmVu", 
            "Y3lfQ05IEAMqtgEKDENsdFJpc2tMZXZlbBIhChRDbHRSaXNrTGV2ZWxfVW5r", 
            "bm93bhD///////////8BEhUKEUNsdFJpc2tMZXZlbF9TYWZlEAASGAoUQ2x0", 
            "Umlza0xldmVsX1dhcm5pbmcQARIXChNDbHRSaXNrTGV2ZWxfRGFuZ2VyEAIS", 
            "HQoZQ2x0Umlza0xldmVsX0Fic29sdXRlU2FmZRADEhoKFkNsdFJpc2tMZXZl", 
            "bF9PcHREYW5nZXIQBEJAChNjb20uZnV0dS5vcGVuYXBpLnBiWilnaXRodWIu", 
          "Y29tL2Z1dHVvcGVuL2Z0YXBpNGdvL3BiL3RyZGNvbW1vbg=="));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Trd_Common_Funds__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.TrdCommon.Funds, global::Futu.OpenApi.Pb.TrdCommon.Funds.Builder>(internal__static_Trd_Common_Funds__Descriptor,
                new string[] { "Power", "TotalAssets", "Cash", "MarketVal", "FrozenCash", "DebtCash", "AvlWithdrawalCash", "Currency", "AvailableFunds", "UnrealizedPL", "RealizedPL", "RiskLevel", "InitialMargin", "MaintenanceMargin", "CashInfoList", });
    ...
    public sealed partial class Funds : pb::GeneratedMessage<Funds, Funds.Builder> {
      ...
      private static readonly string[] _fundsFieldNames = new string[] { "availableFunds", "avlWithdrawalCash", "cash", "cashInfoList", "currency", "debtCash", "frozenCash", "initialMargin", "maintenanceMargin", "marketVal", "power", "realizedPL", "riskLevel", "totalAssets", "unrealizedPL" };
      private static readonly uint[] _fundsFieldTags = new uint[] { 73, 57, 25, 122, 64, 49, 41, 105, 113, 33, 9, 89, 96, 17, 81 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasPower) {
          output.WriteDouble(1, field_names[10], Power);
        }
        if (hasTotalAssets) {
          output.WriteDouble(2, field_names[13], TotalAssets);
        }
        if (hasCash) {
          output.WriteDouble(3, field_names[2], Cash);
        }
        if (hasMarketVal) {
          output.WriteDouble(4, field_names[9], MarketVal);
        }
        if (hasFrozenCash) {
        ...
        if (hasUnrealizedPL) {
          output.WriteDouble(10, field_names[14], UnrealizedPL);
        }
        if (hasRealizedPL) {
          output.WriteDouble(11, field_names[11], RealizedPL);
        }
        if (hasRiskLevel) {
          output.WriteInt32(12, field_names[12], RiskLevel);
        }
        if (hasInitialMargin) {
          output.WriteDouble(13, field_names[7], InitialMargin);
        }
        if (hasMaintenanceMargin) {
          output.WriteDouble(14, field_names[8], MaintenanceMargin);
        }
