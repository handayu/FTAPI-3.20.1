...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class GetGlobalState {
    ...
    static GetGlobalState() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "AigEUgZ1c2VySUQi2AMKA1MyQxIaCghtYXJrZXRISxgBIAIoBVIIbWFya2V0", 
            "SEsSGgoIbWFya2V0VVMYAiACKAVSCG1hcmtldFVTEhoKCG1hcmtldFNIGAMg", 
            "AigFUghtYXJrZXRTSBIaCghtYXJrZXRTWhgEIAIoBVIIbWFya2V0U1oSJgoO", 
            "bWFya2V0SEtGdXR1cmUYBSACKAVSDm1hcmtldEhLRnV0dXJlEh4KCnFvdExv", 
            "Z2luZWQYBiACKAhSCnFvdExvZ2luZWQSHgoKdHJkTG9naW5lZBgHIAIoCFIK", 
            "dHJkTG9naW5lZBIcCglzZXJ2ZXJWZXIYCCACKAVSCXNlcnZlclZlchIkCg1z", 
            "ZXJ2ZXJCdWlsZE5vGAkgAigFUg1zZXJ2ZXJCdWlsZE5vEhIKBHRpbWUYCiAC", 
            "KANSBHRpbWUSHAoJbG9jYWxUaW1lGAsgASgBUglsb2NhbFRpbWUSOwoNcHJv", 
            "Z3JhbVN0YXR1cxgMIAEoCzIVLkNvbW1vbi5Qcm9ncmFtU3RhdHVzUg1wcm9n", 
            "cmFtU3RhdHVzEiIKDHFvdFN2cklwQWRkchgNIAEoCVIMcW90U3ZySXBBZGRy", 
            "EiIKDHRyZFN2cklwQWRkchgOIAEoCVIMdHJkU3ZySXBBZGRyIjAKB1JlcXVl", 
            "c3QSJQoDYzJzGAEgAigLMhMuR2V0R2xvYmFsU3RhdGUuQzJTUgNjMnMigwEK", 
            "CFJlc3BvbnNlEh4KB3JldFR5cGUYASACKAU6BC00MDBSB3JldFR5cGUSFgoG", 
            "cmV0TXNnGAIgASgJUgZyZXRNc2cSGAoHZXJyQ29kZRgDIAEoBVIHZXJyQ29k", 
            "ZRIlCgNzMmMYBCABKAsyEy5HZXRHbG9iYWxTdGF0ZS5TMkNSA3MyY0JFChNj", 
            "b20uZnV0dS5vcGVuYXBpLnBiWi5naXRodWIuY29tL2Z1dHVvcGVuL2Z0YXBp", 
          "NGdvL3BiL2dldGdsb2JhbHN0YXRl"));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_GetGlobalState_S2C__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.GetGlobalState.S2C, global::Futu.OpenApi.Pb.GetGlobalState.S2C.Builder>(internal__static_GetGlobalState_S2C__Descriptor,
                new string[] { "MarketHK", "MarketUS", "MarketSH", "MarketSZ", "MarketHKFuture", "QotLogined", "TrdLogined", "ServerVer", "ServerBuildNo", "Time", "LocalTime", "ProgramStatus", "QotSvrIpAddr", "TrdSvrIpAddr", });
    ...
    public sealed partial class S2C : pb::GeneratedMessage<S2C, S2C.Builder> {
      ...
      private static readonly string[] _s2CFieldNames = new string[] { "localTime", "marketHK", "marketHKFuture", "marketSH", "marketSZ", "marketUS", "programStatus", "qotLogined", "qotSvrIpAddr", "serverBuildNo", "serverVer", "time", "trdLogined", "trdSvrIpAddr" };
      private static readonly uint[] _s2CFieldTags = new uint[] { 89, 8, 40, 24, 32, 16, 98, 48, 106, 72, 64, 80, 56, 114 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasQotLogined) {
          output.WriteBool(6, field_names[7], QotLogined);
        }
        if (hasTrdLogined) {
          output.WriteBool(7, field_names[12], TrdLogined);
        }
        if (hasServerVer) {
          output.WriteInt32(8, field_names[10], ServerVer);
        }
        if (hasServerBuildNo) {
          output.WriteInt32(9, field_names[9], ServerBuildNo);
        }
        if (hasTime) {
          output.WriteInt64(10, field_names[11], Time);
        }
        if (hasLocalTime) {
          output.WriteDouble(11, field_names[0], LocalTime);
        }
        if (hasProgramStatus) {
          output.WriteMessage(12, field_names[6], ProgramStatus);
        }
        if (hasQotSvrIpAddr) {
          output.WriteString(13, field_names[8], QotSvrIpAddr);
        }
        if (hasTrdSvrIpAddr) {
          output.WriteString(14, field_names[13], TrdSvrIpAddr);
        }
        UnknownFields.WriteTo(output);
      }
