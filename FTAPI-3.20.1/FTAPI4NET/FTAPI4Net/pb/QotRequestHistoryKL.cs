...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class QotRequestHistoryKL {
    ...
    static QotRequestHistoryKL() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "b3J5S0waDENvbW1vbi5wcm90bxoQUW90X0NvbW1vbi5wcm90byKTAgoDQzJT", 
            ...
            "IoIBCgNTMkMSMAoIc2VjdXJpdHkYASACKAsyFC5Rb3RfQ29tbW9uLlNlY3Vy", 
            "aXR5UghzZWN1cml0eRIpCgZrbExpc3QYAiADKAsyES5Rb3RfQ29tbW9uLktM", 
            "aW5lUgZrbExpc3QSHgoKbmV4dFJlcUtleRgDIAEoDFIKbmV4dFJlcUtleSI2", 
            "CgdSZXF1ZXN0EisKA2MycxgBIAIoCzIZLlFvdF9SZXF1ZXN0SGlzdG9yeUtM", 
            "LkMyU1IDYzJzIokBCghSZXNwb25zZRIeCgdyZXRUeXBlGAEgAigFOgQtNDAw", 
            "UgdyZXRUeXBlEhYKBnJldE1zZxgCIAEoCVIGcmV0TXNnEhgKB2VyckNvZGUY", 
            "AyABKAVSB2VyckNvZGUSKwoDczJjGAQgASgLMhkuUW90X1JlcXVlc3RIaXN0", 
            "b3J5S0wuUzJDUgNzMmNCSgoTY29tLmZ1dHUub3BlbmFwaS5wYlozZ2l0aHVi", 
          "LmNvbS9mdXR1b3Blbi9mdGFwaTRnby9wYi9xb3RyZXF1ZXN0aGlzdG9yeWts"));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Qot_RequestHistoryKL_C2S__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.QotRequestHistoryKL.C2S, global::Futu.OpenApi.Pb.QotRequestHistoryKL.C2S.Builder>(internal__static_Qot_RequestHistoryKL_C2S__Descriptor,
                new string[] { "RehabType", "KlType", "Security", "BeginTime", "EndTime", "MaxAckKLNum", "NeedKLFieldsFlag", "NextReqKey", });
    ...
    public sealed partial class C2S : pb::GeneratedMessage<C2S, C2S.Builder> {
      ...
      private static readonly string[] _c2SFieldNames = new string[] { "beginTime", "endTime", "klType", "maxAckKLNum", "needKLFieldsFlag", "nextReqKey", "rehabType", "security" };
      private static readonly uint[] _c2SFieldTags = new uint[] { 34, 42, 16, 48, 56, 66, 8, 26 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasRehabType) {
          output.WriteInt32(1, field_names[6], RehabType);
        }
        if (hasKlType) {
          output.WriteInt32(2, field_names[2], KlType);
        }
        if (hasSecurity) {
          output.WriteMessage(3, field_names[7], Security);
        }
        if (hasBeginTime) {
        ...
        if (hasNextReqKey) {
          output.WriteBytes(8, field_names[5], NextReqKey);
        }
