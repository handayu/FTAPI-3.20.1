...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class TrdGetMaxTrdQtys {
    ...
    static TrdGetMaxTrdQtys() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "DENvbW1vbi5wcm90bxoQVHJkX0NvbW1vbi5wcm90byKGAgoDQzJTEi0KBmhl", 
            ...
            "c2VjTWFya2V0GAggASgFUglzZWNNYXJrZXQibAoDUzJDEi0KBmhlYWRlchgB", 
            "IAIoCzIVLlRyZF9Db21tb24uVHJkSGVhZGVyUgZoZWFkZXISNgoKbWF4VHJk", 
            "UXR5cxgCIAEoCzIWLlRyZF9Db21tb24uTWF4VHJkUXR5c1IKbWF4VHJkUXR5", 
            "cyIzCgdSZXF1ZXN0EigKA2MycxgBIAIoCzIWLlRyZF9HZXRNYXhUcmRRdHlz", 
            "LkMyU1IDYzJzIoYBCghSZXNwb25zZRIeCgdyZXRUeXBlGAEgAigFOgQtNDAw", 
            "UgdyZXRUeXBlEhYKBnJldE1zZxgCIAEoCVIGcmV0TXNnEhgKB2VyckNvZGUY", 
            "AyABKAVSB2VyckNvZGUSKAoDczJjGAQgASgLMhYuVHJkX0dldE1heFRyZFF0", 
            "eXMuUzJDUgNzMmNCRwoTY29tLmZ1dHUub3BlbmFwaS5wYlowZ2l0aHViLmNv", 
          "bS9mdXR1b3Blbi9mdGFwaTRnby9wYi90cmRnZXRtYXh0cmRxdHlz"));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Trd_GetMaxTrdQtys_C2S__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.TrdGetMaxTrdQtys.C2S, global::Futu.OpenApi.Pb.TrdGetMaxTrdQtys.C2S.Builder>(internal__static_Trd_GetMaxTrdQtys_C2S__Descriptor,
                new string[] { "Header", "OrderType", "Code", "Price", "OrderID", "AdjustPrice", "AdjustSideAndLimit", "SecMarket", });
    ...
    public sealed partial class C2S : pb::GeneratedMessage<C2S, C2S.Builder> {
      ...
      private static readonly string[] _c2SFieldNames = new string[] { "adjustPrice", "adjustSideAndLimit", "code", "header", "orderID", "orderType", "price", "secMarket" };
      private static readonly uint[] _c2SFieldTags = new uint[] { 48, 57, 26, 10, 40, 16, 33, 64 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasOrderType) {
          output.WriteInt32(2, field_names[5], OrderType);
        }
        if (hasCode) {
        ...
        if (hasSecMarket) {
          output.WriteInt32(8, field_names[7], SecMarket);
        }
