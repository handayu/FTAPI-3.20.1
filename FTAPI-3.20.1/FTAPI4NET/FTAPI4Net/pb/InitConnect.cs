...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class InitConnect {
    ...
    static InitConnect() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "byKpAQoDQzJTEhwKCWNsaWVudFZlchgBIAIoBVIJY2xpZW50VmVyEhoKCGNs", 
            "aWVudElEGAIgAigJUghjbGllbnRJRBIeCgpyZWN2Tm90aWZ5GAMgASgIUgpy", 
            "ZWN2Tm90aWZ5EiQKDXBhY2tldEVuY0FsZ28YBCABKAVSDXBhY2tldEVuY0Fs", 
            "Z28SIgoMcHVzaFByb3RvRm10GAUgASgFUgxwdXNoUHJvdG9GbXQixwEKA1My", 
            "QxIcCglzZXJ2ZXJWZXIYASACKAVSCXNlcnZlclZlchIgCgtsb2dpblVzZXJJ", 
            "RBgCIAIoBFILbG9naW5Vc2VySUQSFgoGY29ubklEGAMgAigEUgZjb25uSUQS", 
            "HgoKY29ubkFFU0tleRgEIAIoCVIKY29ubkFFU0tleRIsChFrZWVwQWxpdmVJ", 
            "bnRlcnZhbBgFIAIoBVIRa2VlcEFsaXZlSW50ZXJ2YWwSGgoIYWVzQ0JDaXYY", 
            "BiABKAlSCGFlc0NCQ2l2Ii0KB1JlcXVlc3QSIgoDYzJzGAEgAigLMhAuSW5p", 
            "dENvbm5lY3QuQzJTUgNjMnMigAEKCFJlc3BvbnNlEh4KB3JldFR5cGUYASAC", 
            "KAU6BC00MDBSB3JldFR5cGUSFgoGcmV0TXNnGAIgASgJUgZyZXRNc2cSGAoH", 
            "ZXJyQ29kZRgDIAEoBVIHZXJyQ29kZRIiCgNzMmMYBCABKAsyEC5Jbml0Q29u", 
            "bmVjdC5TMkNSA3MyY0JCChNjb20uZnV0dS5vcGVuYXBpLnBiWitnaXRodWIu", 
          "Y29tL2Z1dHVvcGVuL2Z0YXBpNGdvL3BiL2luaXRjb25uZWN0"));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_InitConnect_C2S__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.InitConnect.C2S, global::Futu.OpenApi.Pb.InitConnect.C2S.Builder>(internal__static_InitConnect_C2S__Descriptor,
                new string[] { "ClientVer", "ClientID", "RecvNotify", "PacketEncAlgo", "PushProtoFmt", });
        ...
        internal__static_InitConnect_S2C__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.InitConnect.S2C, global::Futu.OpenApi.Pb.InitConnect.S2C.Builder>(internal__static_InitConnect_S2C__Descriptor,
                new string[] { "ServerVer", "LoginUserID", "ConnID", "ConnAESKey", "KeepAliveInterval", "AesCBCiv", });
    ...
    public sealed partial class C2S : pb::GeneratedMessage<C2S, C2S.Builder> {
      ...
      private static readonly string[] _c2SFieldNames = new string[] { "clientID", "clientVer", "packetEncAlgo", "pushProtoFmt", "recvNotify" };
      private static readonly uint[] _c2SFieldTags = new uint[] { 18, 8, 32, 40, 24 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasRecvNotify) {
          output.WriteBool(3, field_names[4], RecvNotify);
        }
        if (hasPacketEncAlgo) {
          output.WriteInt32(4, field_names[2], PacketEncAlgo);
        }
        if (hasPushProtoFmt) {
          output.WriteInt32(5, field_names[3], PushProtoFmt);
        }
    ...
    public sealed partial class S2C : pb::GeneratedMessage<S2C, S2C.Builder> {
      ...
      private static readonly string[] _s2CFieldNames = new string[] { "aesCBCiv", "connAESKey", "connID", "keepAliveInterval", "loginUserID", "serverVer" };
      private static readonly uint[] _s2CFieldTags = new uint[] { 50, 34, 24, 40, 16, 8 };
