  ...
  public static partial class TestCmd {
    ...
    static TestCmd() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "Cg1UZXN0Q21kLnByb3RvEgdUZXN0Q21kIi8KA0MyUxIQCgNjbWQYASACKAlS", 
            "A2NtZBIWCgZwYXJhbXMYAiABKAlSBnBhcmFtcyIvCgNTMkMSEAoDY21kGAEg", 
            "AigJUgNjbWQSFgoGcmVzdWx0GAIgAigJUgZyZXN1bHQiKQoHUmVxdWVzdBIe", 
            "CgNjMnMYASACKAsyDC5UZXN0Q21kLkMyU1IDYzJzInwKCFJlc3BvbnNlEh4K", 
            "B3JldFR5cGUYASACKAU6BC00MDBSB3JldFR5cGUSFgoGcmV0TXNnGAIgASgJ", 
            "UgZyZXRNc2cSGAoHZXJyQ29kZRgDIAEoBVIHZXJyQ29kZRIeCgNzMmMYBCAB", 
            "KAsyDC5UZXN0Q21kLlMyQ1IDczJjQj4KE2NvbS5mdXR1Lm9wZW5hcGkucGJa", 
          "J2dpdGh1Yi5jb20vZnV0dW9wZW4vZnRhcGk0Z28vcGIvdGVzdGNtZA=="));
    ...
    public sealed partial class C2S : pb::GeneratedMessage<C2S, C2S.Builder> {
      ...
      private static readonly string[] _c2SFieldNames = new string[] { "cmd", "params" };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasParams) {
          output.WriteString(2, field_names[1], Params);
        }
    ...
    public sealed partial class S2C : pb::GeneratedMessage<S2C, S2C.Builder> {
      ...
      private static readonly string[] _s2CFieldNames = new string[] { "cmd", "result" };
