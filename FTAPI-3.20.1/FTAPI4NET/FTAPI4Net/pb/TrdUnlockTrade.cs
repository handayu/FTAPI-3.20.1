...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class TrdUnlockTrade {
    ...
    static TrdUnlockTrade() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "bW9uLnByb3RvIjUKA0MyUxIWCgZ1bmxvY2sYASACKAhSBnVubG9jaxIWCgZw", 
            "d2RNRDUYAiABKAlSBnB3ZE1ENSIFCgNTMkMiMQoHUmVxdWVzdBImCgNjMnMY", 
            "ASACKAsyFC5UcmRfVW5sb2NrVHJhZGUuQzJTUgNjMnMihAEKCFJlc3BvbnNl", 
            "Eh4KB3JldFR5cGUYASACKAU6BC00MDBSB3JldFR5cGUSFgoGcmV0TXNnGAIg", 
            "ASgJUgZyZXRNc2cSGAoHZXJyQ29kZRgDIAEoBVIHZXJyQ29kZRImCgNzMmMY", 
            "BCABKAsyFC5UcmRfVW5sb2NrVHJhZGUuUzJDUgNzMmNCRQoTY29tLmZ1dHUu", 
    ...
    public sealed partial class C2S : pb::GeneratedMessage<C2S, C2S.Builder> {
      ...
      private static readonly string[] _c2SFieldNames = new string[] { "pwdMD5", "unlock" };
      private static readonly uint[] _c2SFieldTags = new uint[] { 18, 8 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasUnlock) {
          output.WriteBool(1, field_names[1], Unlock);
        }
        if (hasPwdMD5) {
