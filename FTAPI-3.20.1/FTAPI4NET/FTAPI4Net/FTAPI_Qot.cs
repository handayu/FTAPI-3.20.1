...
namespace Futu.OpenApi
{
    public interface FTSPI_Qot
    {
        ...
        void OnReply_GetIpoList(FTAPI_Conn client, int nSerialNo, QotGetIpoList.Response rsp); //获取新股Ipo
        void OnReply_GetFutureInfo(FTAPI_Conn client, int nSerialNo, QotGetFutureInfo.Response rsp); //获取新股Ipo
        void OnReply_RequestTradeDate(FTAPI_Conn client, int nSerialNo, QotRequestTradeDate.Response rsp); //在线拉取交易日
        ...
        void OnReply_SetPriceReminder(FTAPI_Conn client, int nSerialNo, QotSetPriceReminder.Response rsp); //设置到价提醒
        void OnReply_GetPriceReminder(FTAPI_Conn client, int nSerialNo, QotGetPriceReminder.Response rsp); //获取到价提醒
        void OnReply_GetUserSecurityGroup(FTAPI_Conn client, int nSerialNo, QotGetUserSecurityGroup.Response rsp); //获取自选股分组
        ...
        void OnReply_UpdatePriceReminder(FTAPI_Conn client, int nSerialNo, QotUpdatePriceReminder.Response rsp); //到价提醒通知
    }
                    ...
                    case ProtoID.QotGetIpoList:
                        {
                            ...
                            this.qotCallback.OnReply_GetIpoList(this, serialNo, rsp);
                        }
                        break;
                    case ProtoID.QotGetFutureInfo:
                        {
                            ...
                            this.qotCallback.OnReply_GetFutureInfo(this, serialNo, rsp);
                        }
                        break;
                    case ProtoID.QotRequestTradeDate:
                        {
                            ...
                            this.qotCallback.OnReply_RequestTradeDate(this, serialNo, rsp);
                        }
                        break;
                    case ProtoID.QotSetPriceReminder:
                        {
                            ...
                            this.qotCallback.OnReply_SetPriceReminder(this, serialNo, rsp);
                        }
                        break;
                    case ProtoID.QotGetPriceReminder:
                        {
                            ...
                            this.qotCallback.OnReply_GetPriceReminder(this, serialNo, rsp);
                        }
                        break;
                    case ProtoID.QotGetUserSecurityGroup:
                        {
                            ...
                            this.qotCallback.OnReply_GetUserSecurityGroup(this, serialNo, rsp);
                        }
                        break;
                }
            }
                    ...
                    case ProtoID.QotUpdatePriceReminder://推送到价提醒通知
                        {
                            ...
                            this.qotCallback.OnReply_UpdatePriceReminder(this, serialNo, rsp);
                        }
                        break;
                }
            }
